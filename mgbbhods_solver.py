...
'''
#--------------------------------------------------------------------------
# TODO: Select cotrechos for downscaling (default= all available) and time-series
#--------------------------------------------------------------------------
# select cotrechos to downscale stats
if not list_to_downscale_stats:
    list_to_downscale_stats = available_to_downscale.copy()


# select cotrechos to downscale time-series
flag_ts = False
'''
...
_ = funcs_gpkg.f_dicts_to_bho_gpkg(gdf_tble_bho, D, suffix='flows_1979')
